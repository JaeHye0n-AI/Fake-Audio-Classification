...
test_loader = mk_test_dataset(config.test_data_path)


pretrained_model = f'{study_path}/best_model_ver_4.pt'
...
test_time_adap(model, test_loader, optimizer, device, study_path, test_df)